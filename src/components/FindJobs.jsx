...
<div className="w-1/3 space-y-6">
              ...
              <div className="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col items-start">
                <h3 className="text-white font-bold text-xl">Quick Tip</h3>
                <p className="text-gray-400 text-base">
                  Want to improve your chances of getting noticed? Make sure your resume and portfolio are up to date.
                </p>
                <Button className="mt-4 px-4 py-2 bg-purple-400 text-white text-sm rounded-md hover:bg-purple-500 transition duration-200">
                  Learn More
                </Button>
              </div>
            </div>
        ...
        <div className="flex flex-col mt-12 space-y-12 w-1/3">
