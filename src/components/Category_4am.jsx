  ...
  useEffect(() => {
    ...
    fetch(url)
      .then((response) => {
        ...
        console.log('fetchurl',response.url);
        console.log('fdata', response.json());
        return response.json();
      })
      .then((userData) => {
        setUserData(userData); // Set the fetched data to state
        setLoading(false); // Stop loading
      })
      .then((filteredItems) => {
        setFilteredItems(filteredItems); // Set the fetched data to state
        setLoading(false); // Stop loading
      })
      .catch((error) => {
      ...
      //setFilteredItems(response.json());  
  }, []);
